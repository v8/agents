...
- Swift source files must be referenced by a `swift_source_set` build rule which
  defines a build target that contains only swift code.
...
- Refer to the documentation for
  [C++ interop](https://www.swift.org/documentation/cxx-interop/#importing-c-into-swift)
